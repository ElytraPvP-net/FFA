...
public class TopKillsGUI extends CustomGUI {
    ...
    public TopKillsGUI(Player player) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(FFA.getPlugin(), () -> {
            for(int place : LeaderboardUpdate.kills.keySet()) {
                UUID u = LeaderboardUpdate.kills.get(place).u;
                int num = LeaderboardUpdate.kills.get(place).i;
